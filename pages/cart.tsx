    ...
    <Layout>
      {cartItems.length <= 0 ? (
        ...
        cartItems.map((item: any) => (
          <div className="flex flex-row my-3 items-center bg-transparent  rounded-xl shadow-2xl max-w-5xl h-32">
            ...
            <button className="border rounded-xl p-2 text-white flex flex-row hover:bg-white hover:text-black" onClick={removeFromCart}>
