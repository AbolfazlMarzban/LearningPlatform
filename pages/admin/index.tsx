            ...
            (
                <>
                    <div className='flex flex-col gap-3 w-full h-screen items-center justify-center'>
                        {showError && (
                            <span className='text-red-600 font-bold text-lg'>Incorect Information!</span>
                        )}
                            <label htmlFor="" className='text-lg'>username</label>
                            <input type="text" className='border border-2 rounded-lg p-2' />
                            <label htmlFor="" className='text-lg'>password</label>
                            <input type="text" className='border border-2 rounded-lg p-2' />
                            <button className='bg-green-400 text-white px-10 py-1 rounded-lg' onClick={()=>enterUser()}>Enter</button>
                    </div>
                </>
            )    
            :
